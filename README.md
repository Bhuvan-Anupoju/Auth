...
-  Email Sending using Node Mailer
...
- OTP is generated and sent to the user's email using  Node Mailer ✉️
- User verifies OTP 🔢
...
- Verify authorized access between frontend and backend 🔄
## 🚀 Future Improvements
...
- [My Portfolio](https://bhuvan-anupoju.github.io/ddd/)
